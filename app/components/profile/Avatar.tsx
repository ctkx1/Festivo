...
interface AvatarProps {
  ...
  updateProfile: (data: { username: string, date_of_birth: Date | null, avatar_url: string | null }) => Promise<void>
}
  ...
  const pickImage = async () => {
    try {
      ...
      if (!permissionResult.granted) {
        Alert.alert('Błąd', 'Potrzebujemy dostępu do Twoich zdjęć aby kontynuować')
        return
      }
